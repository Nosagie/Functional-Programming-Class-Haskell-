...
{-BUT as the question is worth 10 points, I shall attempt to give an answer 
	The goal of this assignment is to make us more comfortable with defining and manipulatiing
	our own datatypes. Implementing treeFilter neither deepens our understanding of data-types
	nor reveals any subtleties regarding the Tree datatype we have created, insofar as it utilizes
	constructs that you expect be familiar with. Another possible reason is that filtering is not 
	a very useful operation when compared to the other operations we've performed and implemented on 
	our tree.
-}
